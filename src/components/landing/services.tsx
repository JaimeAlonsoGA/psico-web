        ...
        <section className="py-24 px-4 bg-background">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    {/* Individual Therapy */}
                    <Card className="group hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 hover:border-primary/50 animate-fade-in">
                    ...
                    {/* Group Therapy */}
                    <Card className="group hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 hover:border-secondary/50 animate-fade-in delay-200">
                        <div className="relative h-80 overflow-hidden">
                            <img
